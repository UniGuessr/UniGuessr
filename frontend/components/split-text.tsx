...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick, fontSize = "clamp(4rem, 15vw, 14rem)", transparent = false, customColor }: SplitFlapCharProps) {
